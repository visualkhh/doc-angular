...
//
var CodeCraftValidators = /** @class */ (function () {
    function CodeCraftValidators() {
    }
    CodeCraftValidators.emailDomain = function (requiredDomain) {
...
var EmailDomainValidator = /** @class */ (function () {
    ...
    EmailDomainValidator_1 = EmailDomainValidator;
    EmailDomainValidator.prototype.ngOnChanges = function () {
        if (this.emailDomain) {
    ...
    EmailDomainValidator.prototype.validate = function (control) {
        return this.valFn(control);
    };
    __decorate([
        core_1.Input('emailDomain'),
        __metadata("design:type", String)
    ], EmailDomainValidator.prototype, "emailDomain", void 0);
    EmailDomainValidator = EmailDomainValidator_1 = __decorate([
        core_1.Directive({
            selector: '[emailDomain][ngModel]',
            providers: [
                {
                    provide: forms_1.NG_VALIDATORS,
                    useExisting: EmailDomainValidator_1,
                    multi: true
                }
            ]
        })
